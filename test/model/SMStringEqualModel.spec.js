...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SMStringEqualModel', function() {
      beforeEach(function() {
        instance = new ProCakeRestApi.SMStringEqualModel();
      });

      it('should create an instance of SMStringEqualModel', function() {
        // TODO: update the code to test SMStringEqualModel
        expect(instance).to.be.a(ProCakeRestApi.SMStringEqualModel);
      });
